...
public class MockWebsocketConnection extends WebSocketConnection {
  ...
  private static WebSocketWatchDog watchDog = new WebSocketWatchDog(new SubscriptionOptions());
  ...
  void connect() {
    try {
      ...
      MemberModifier.field(MockWebsocketConnection.class, "webSocket").set(this, mockWebsocket);
